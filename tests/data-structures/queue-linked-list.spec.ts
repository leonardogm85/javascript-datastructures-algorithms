...
describe('Data Structures: Queue Linked List', () => {
  ...
  it('returns toString primitive types', () => {
    const queueNumber: QueueLinkedList<number> = new QueueLinkedList<number>();
    ...
    const queueString: QueueLinkedList<string> = new QueueLinkedList<string>();
  ...
  it('returns toString objects', () => {
    const queueMyObject: QueueLinkedList<MyObject> = new QueueLinkedList<MyObject>();
