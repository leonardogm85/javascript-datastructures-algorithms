...
describe('QueueLinkedList', () => {
  ...
  it('returns toString primitive types', () => {
    const queueNumber: PriorityQueueLinkedList<number> = new PriorityQueueLinkedList<number>();
    ...
    const queueString: PriorityQueueLinkedList<string> = new PriorityQueueLinkedList<string>();
  ...
  it('returns toString objects', () => {
    const queueMyObject: PriorityQueueLinkedList<MyObject> = new PriorityQueueLinkedList<MyObject>();
