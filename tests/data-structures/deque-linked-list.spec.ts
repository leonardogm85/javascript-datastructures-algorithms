...
describe('DequeLinkedList', () => {
  ...
  it('returns toString primitive types', () => {
    const dequeNumber: DequeLinkedList<number> = new DequeLinkedList<number>();
    ...
    const queueString: DequeLinkedList<string> = new DequeLinkedList<string>();
  ...
  it('returns toString objects', () => {
    const dequeMyObject: DequeLinkedList<MyObject> = new DequeLinkedList<MyObject>();
